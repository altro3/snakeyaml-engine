...
class ExceptionTest {
    ...
    void sequenceException() {
        var exception = assertThrows(YamlEngineException.class, () -> DEFAULT_LOAD.loadFromString("!!seq abc"));
    ...
    @Test
    void intException() {
        var exception = assertThrows(YamlEngineException.class, () -> DEFAULT_LOAD.loadFromString("!!int abc"));
