...
class StreamReaderHighSurrogateTest {
     ...
     */
    @Test
    void testHighSurrogateAtBufferBoundary() {
     ...
     */
    @Test
    void testHighSurrogateAtMultipleBufferBoundaries() {
        var settings = LoadSettings.builder()
            .setBufferSize(10)
            .build();
        ...
        var input = "123456789\uD800\uDC00abcdefghij\uD801\uDC01xyz";

        var reader = new StreamReader(settings, input);
