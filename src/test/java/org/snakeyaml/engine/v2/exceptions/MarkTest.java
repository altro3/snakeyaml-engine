...
class MarkTest {
    ...
    void testGet_snippet() {
        var mark = new Mark("test1", 0, 0, 0, "*The first line.\nThe last line.".toCharArray(), 0);
    ...
    void testPosition() {
        var mark = new Mark("test1", 17, 29, 213, "*The first line.\nThe last line.".toCharArray(), 0);
    ...
    void testGetBuffer() {
        var mark = new Mark("test1", 0, 29, 213, "*The first line.\nThe last line.".toCharArray(), 0);
    ...
    void testGetReducedSnippet() {
        var mark = new Mark("test1", 200, 2, 36,
