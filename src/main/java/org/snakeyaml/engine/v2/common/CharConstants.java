...
public final class CharConstants {
     ...
     */
    public static final Map<Character, String> ESCAPE_REPLACEMENTS = Map.ofEntries(
        entry('0', "\0"), // ASCII null
        entry('a', "\u0007"), // ASCII bell
     ...
     * </pre>
     */
    public static final Map<Character, Integer> ESCAPE_CODES = Map.of('x', 2, // 8-bit Unicode
        'u', 4, // 16-bit Unicode
    ...
    public static String escapeChar(String chRepresentation) {
        for (var c : ESCAPE_REPLACEMENTS.keySet()) {
            String v = ESCAPE_REPLACEMENTS.get(c);
